...
namespace nilnul.fs.git.module.repo._cfg_.remote_.bak_.bb.key
{
	static public class _VwX1
	{

		static public NameVer LatestOrDefault(nilnul.fs.git.ModuleI module, nilnul.win.prog_.Git git = null)
		{
