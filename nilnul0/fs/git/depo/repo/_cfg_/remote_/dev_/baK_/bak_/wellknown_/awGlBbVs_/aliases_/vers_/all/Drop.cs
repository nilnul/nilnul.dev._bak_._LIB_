...
namespace nilnul.fs.git.module.repo._cfg_.remote_.bak_.wellknown_.awGlBbVs.aliases_.vers_.all
{
	static public class _DropX
	{
		...
		public static void Void_ofAddress(string v)
		{
			Void(
		...
		public static void Void(Module module, G git=null)
		{
			...
			foreach (var item in _VsAwGlBbX.GetKeys())
			{
