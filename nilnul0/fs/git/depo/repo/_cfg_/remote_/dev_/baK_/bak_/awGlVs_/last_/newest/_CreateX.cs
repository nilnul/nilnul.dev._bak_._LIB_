...
namespace nilnul.fs.git.module.repo._cfg_.remote_.bak_.awGlVs_.last_.next
{
	/// <summary>
	...
	static public class _CreateX
	{
		...
		)
		{
			...
			var notNuls = new[] { aw, gl,  vs }.Where(x => x != null);
			...
			if (notNuls.Any())
			{
				...
				var nextKey = nilnul.fs.git.module.repo._cfg_.remote_.bak_.awGlVs_.newest_.next._VwX.NameVer(gitTop, git);
