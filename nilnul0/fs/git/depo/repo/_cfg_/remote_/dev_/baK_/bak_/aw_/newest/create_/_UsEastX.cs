...
namespace nilnul.fs.git.module.repo._cfg_.remote_.bak_.aw_.newest.create_
{
	////extern alias git;
	static public class _OhioX
	{
		...
		static public void Void(
			nilnul.fs.git.ModuleI _gitTop,  nilnul.fs.git.svr.repo.Name svrRepoName,  nilnul.win.prog_.Git git = null)
		{
