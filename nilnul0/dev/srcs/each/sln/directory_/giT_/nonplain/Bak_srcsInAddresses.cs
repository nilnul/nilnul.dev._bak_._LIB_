...
namespace nilnul.dev.srcs.each.sln.directory_.giT_.nonplain
{
	/// <summary>
	/// </summary>
	public class Bak_srcsInAddresses
	{
		...
		)
		{
			...
			{
				new directory_.giT_.work.Bak_srcsInAddresses(cfg, innerModules,innerModules2reinclude) { module=this.module}.__exe(folder);
			}
