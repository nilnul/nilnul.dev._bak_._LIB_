...
namespace nilnul.dev.sln.directory_.nonlink_.nonneglect_.giT_.work
{
	public class Bak
	{
		...
		public void __exe_ofAddress(string sln)
		{
			...
			{
				new nilnul.dev.sln_.nonlink.directory_.nonlink_.nonneglect_.git_.work_.top.Bak(cfg)._Exe(sln);
			}
			else
			{
				new nilnul.dev.sln_.nonlink.directory_.nonlink_.nonneglect_.git_.work_.nontop.Bak(cfg, innerModules){module=this.module}._exe(sln);
			}
		}
