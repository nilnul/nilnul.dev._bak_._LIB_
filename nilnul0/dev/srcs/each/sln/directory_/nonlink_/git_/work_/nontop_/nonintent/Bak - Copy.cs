...
namespace nilnul.dev.sln_.nonlink.directory_.nonlink_.giT_.work_.nontop_.nonintent
{
	public class Bak_srcsInAddresses
	{
		...
		public Bak_srcsInAddresses(nilnul.fs.addresses_.disjoint.deV_._bak.Io cfg, ConcurrentBag<DivI> innerModules) : this(cfg, innerModules, new ConcurrentBag<DivI>())
		{
			//this.cfg = cfg;
		...
		{
			if (nilnul.fs.folder.be_.deV_.baK_._NonparticipantX.Be_ofAddress(
