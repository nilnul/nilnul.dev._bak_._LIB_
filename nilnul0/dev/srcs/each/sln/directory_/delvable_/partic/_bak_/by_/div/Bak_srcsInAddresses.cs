...
namespace nilnul.dev.srcs.each.sln.directory_.delvable_.partic._bak_.by_
{
	...
	/// </summary>
	///
	[Obsolete("categorize according to git first; then depth1st; then for the intent.",true)]
	...
	public class Bak_srcsInAddresses
	{
		...
		{
			/// todo: create a ad-hoc one from the follows:
			new sln.div_.delvable_.partic.Bak_srcsInAddresses(cfg,innerModules,innerModules2reinclude,module).vod_ofAddress(folder);
		}
