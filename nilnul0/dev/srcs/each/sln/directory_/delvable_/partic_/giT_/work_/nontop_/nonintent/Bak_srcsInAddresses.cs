...
namespace nilnul.dev.srcs.each.sln.directory_.delvable_.partic_.giT_.work_.nontop_.nonintent
{
	public class Bak_srcsInAddresses
	{
			...
			)
		{
			...
			new div_.delvable_.partic_.giT_.work_.nontop_.nonintent.Bak_srcsInAddresses(cfg, innerModules,innerModules2reinclude,module)._exe(_location__nonrootWork);
