...
namespace nilnul.dev.srcs.each.sln.directory_.delvable_.partic_.giT_.work_.nontop
{
	/// <summary>
	...
	public class Bak_srcsInAddresses
	{
		...
		internal Bak_srcsInAddresses(nilnul.fs.addresses_.disjoint.deV_._bak.Io cfg, ConcurrentBag<DivI> innerModules, ConcurrentBag<DivI> innerModules2reinclude) : this(cfg, innerModules, innerModules2reinclude, null)
		{
		...
		)
		{
			...
			)
			{
				...
				nontop_.intent.Bak_srcsInAddresses.Bak(cfg, module, innerModules, innerModules2reinclude, folder);
				return;
