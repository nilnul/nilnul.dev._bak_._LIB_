...
namespace nilnul.dev.srcs.each.sln.directory_.delvable_.giT_.work_.nontop
{
	public class Bak_srcsInAddresses
	{
		...
		)
		{
			...
			)
			{
				...
				nontop_.intent.Bak_srcsInAddresses.Bak(
					cfg, module, innerModules, innerModules2reinclude, folder);
				return;
