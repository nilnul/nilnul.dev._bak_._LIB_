...
namespace nilnul.dev.srcs.each.sln.div_.delvable_.partic_.giT_.plain
{
	public class BakByIntent
	{
		...
		{
			//new partic_.giT_._plain.Depth1st(cfg, innerModules, this.innerModules2reinclude) { module = this.module }._vod(folder);
			...
			try
			{
				...
				)
				{
					 ...
					 plain_.intent.Bak.Vod(cfg, module, innerModules, innerModules2reinclude,folder);
