...
namespace nilnul.dev.sln.div_.nonlink_.nonneglect_.giT_.plain0Nontop_._intent_._content_.dir_.plain
{
	[Obsolete()]
	public class Bak
	{
		...
		public void __Exe(string work)
		{
			...
			foreach (string child in nilnul.fs.folder.dirs_.excludeVs_._NormalX.EnumerateAsAddresses(work))
			{
				...
				if (nilnul.fs.folder.be_.deV_.baK_._NonparticipantX.Be_ofAddress(child))
				{
					continue;
				}
