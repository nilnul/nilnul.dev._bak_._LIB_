...
namespace nilnul.dev.srcs.each.sln.directory
{
	...
	public class Bak_srcsInAddresses
	{
		...
		{
			///we will look at the dir itself(as the container) first.
			new div.dir.Bak_srcsInAddresses(this._cfg,this.innerModules,innerModules2reinclude,module).__exe(folder);
