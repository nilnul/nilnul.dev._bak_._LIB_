...
namespace System.Threading.Tasks.Schedulers
{
	...
	public sealed class QueuedTaskScheduler : TaskScheduler, IDisposable
	{
			...
			int maxConcurrencyLevel)
		{
			...
			// If 0, use the number of logical processors.  But make sure whatever value we pick is not greater than the degree of parallelism allowed by the underlying scheduler.
		...
		/// <summary>A group of queues at the same priority level.</summary>
