		...
		)
		{
			...
			switch (distance)
			{
				case 0: //src
					...
					break;
				case 1: //sln
					new nilnul.dev.src.sln_.unjoint_.nonneglect.Bak_srcsInAddresses(cfg,innerModules,innerModules2reinclude,module).__exe(_div_inSrc.ToString());
					break;

				default:    //inside sln
					new nilnul.dev.src.sln.directory_.unjoint_.nonneglect.Bak_srcsInAddresses(cfg,innerModules,innerModules2reinclude,module)._exe(
						 shield
						);
					break;
			}
