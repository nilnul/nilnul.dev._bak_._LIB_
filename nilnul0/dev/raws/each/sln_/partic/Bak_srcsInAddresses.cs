...
namespace nilnul.dev.sln_.partic
{
	/// <summary>
	/// </summary>
	///
	[Obsolete("the order and logic needs further investigation",true)]
	public  class Bak_srcsInAddresses
	{
		...
		{
			new sln_.nonlink.div_.nonlink_.partic_.intent.Bak_srcsInAddress(cfg).Exe(folder);
		}
