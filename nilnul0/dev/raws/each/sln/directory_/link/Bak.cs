...
namespace nilnul.dev.srcs.each.sln.directory_.link
{
	/// <summary>
	/// 
	/// </summary>
	/// <see cref="sln.div.dir_.link.Bak4unjoint"/>
	public class Bak4unjoint
	{
		...
		)
		{
			...
			if (old.Key is null)
			{
				...
				new directory_.delvable.Bak4unjoint(cfg, innerModules, innerModules2reinclude, module) { }._exe(shield);
