...
namespace nilnul.dev.srcs.each.sln.directory_.delvable_.giT_.nonplain
{
	/// <summary>
	/// </summary>
	public class Bak_srcsInAddresses
	{
		...
		)
		{
			...
			{
				new directory_.delvable_.giT_.work.Bak4unjoint(cfg, innerModules,innerModules2reinclude) { module=this.module}.__exe(folder);
			}
