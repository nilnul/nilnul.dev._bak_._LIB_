	...
	public class Bak
	{
		...
		public void __Exe(string work)
		{
			...
			)
			{
				...
				new work_.top.Bak(cfg, innerModules, innerModules2reinclude) { moduleAbove=this.module}.__Exe(work);
			}
			else
			{
				new work_.nontop.Bak(cfg, innerModules,innerModules2reinclude) {module=this.module }._exe(work);
			}
		}
