...
namespace nilnul.dev.sln_.nonlink.directory_.nonlink_.nonneglect_.giT_.plain
{
	public class Bak_srcsInAddresses
	{
		...
		)
		{
			...
			//{
				...
				{
					new plain_.intent.Bak_srcsInAddresses(cfg).Exe(folder);
				}
				else
				{
					new plain.Bak_srcsInAddresses(cfg) { }._exe_ofAddress(folder);
				}
		}
	}
}
