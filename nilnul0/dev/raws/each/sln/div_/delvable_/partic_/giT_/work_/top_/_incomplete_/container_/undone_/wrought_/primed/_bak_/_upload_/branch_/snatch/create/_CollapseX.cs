...
namespace nilnul.dev.raws.each.sln.div_.delvable_.partic_.giT_.work_.top_._incomplete_.container_.undone_.wrought_.primed._bak_.branch_.snap.create
{
	/// <summary>
	...
	public static class _CollapseX
	{
			...
			nilnul.os.prog_.Git git = null)
		{
			...
			var newBranch= nilnul.dev.raws.each.sln.div_.delvable_.partic_.giT_.work_.top_._incomplete_.container_.undone_.primed._bak_.branch_.shelf.create._collapse._DropRedundantX._Succeed(_location, branch, git);
