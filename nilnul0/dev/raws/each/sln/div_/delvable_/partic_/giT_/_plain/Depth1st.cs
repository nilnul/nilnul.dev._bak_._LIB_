...
namespace nilnul.dev.raws.each.sln.div_.delvable_.partic_.giT_._plain
{
	/// <summary>
	/// 
	/// </summary>
		...
		)
		{
			try
			{
				...
				try
				{
					...
					foreach (var dir in nilnul.fs.folder.dirs_.unclave_.unnegle_.unvsgen_.baK_._ConscriptX._Infos_0folder(
