...
namespace nilnul.dev.raws.each.sln.div_.delvable_.partic_.giT_.work_.top_.incomplete.dir_.delve_.attend_.werk
{
	public class Bak_srcsInAddresses
	{
		...
		public void __exe_0address4dir(string _address4dir)
		{
			if (
				nilnul.fs.folder_.git_.work.be_.Top.Singleton.be_ofAddress(_address4dir, cfg.git)
			)
			{
				//if (module != null)
				//{
				...
				//}
				work_.top.Bak_srcsInAddresses._Vod(cfg, this._module, innerModules, innerModules2reinclude, _address4dir);
				return;
			}
		...
		{
			__exe_0address4dir(work.ToString());
		}
