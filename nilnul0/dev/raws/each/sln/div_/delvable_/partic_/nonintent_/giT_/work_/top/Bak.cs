...
namespace nilnul.dev.srcs.each.sln.div_.delvable_.partic_.nonintent_.giT_.work_.top
{
	public class Bak
	{
		...
		{
			new partic_.giT_.work_.top.Bak_srcsInAddresses(cfg,innerModules,innerModules2reinclude,module) { }._vod();
