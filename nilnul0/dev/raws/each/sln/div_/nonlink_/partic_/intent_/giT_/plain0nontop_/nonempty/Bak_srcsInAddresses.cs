...
namespace nilnul.dev.sln_.nonlink.div_.nonlink_.partic_.intent_.giT_.plain0nontop_.nonempty
{
	/// <summary>
	/// 
	/// </summary>
		...
		)
		{
			...
			try
			{
				cancel.ThrowIfCancellationRequested();
					...
					cancel.ThrowIfCancellationRequested();
					new nilnul.dev.sln_.nonlink.div_.nonlink_.partic_.giT_.work_.top_.incomplete_.moduleUndone.Bak(cfg)._Exe(folderAddress);
