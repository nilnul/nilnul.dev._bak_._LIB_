...
namespace nilnul.dev.sln_.nonlink.div_.nonlink_.partic_.git_.work_.top_._incomplete_.container_.undone_.primed._bak_._upload_.branch_._bak
{
	/// <summary>
	/// add a new bakbranch.
	/// </summary>
	public static class _PutX
	{
		...
		)
		{
			...
			catch (Exception ex)
			{
				...
				/*System.Threading.Thread.Slep(5000)*/
