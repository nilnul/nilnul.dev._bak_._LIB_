...
namespace nilnul.dev.sln_.nonlink.div_.nonlink_.partic_.giT_.work_.top_.incomplete_.moduleUndone
{
	/// <summary>
	/// </summary>
	public  class Bak
	{
		...
		)
		{
			...
			new nilnul.dev.sln.div_.nonlink_.nonneglect_.giT_.work_.top_._incomplete_.container_.undone.Bak_srcsInAddresses(cfg )._exe(folder, innerModules,innerModules2reinclude);
