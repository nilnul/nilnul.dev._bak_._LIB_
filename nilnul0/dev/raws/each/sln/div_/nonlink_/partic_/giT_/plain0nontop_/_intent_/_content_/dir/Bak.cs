...
namespace nilnul.dev.sln.div_.nonlink_.nonneglect_.giT_.plain0Nontop_._intent_._content_.dir
{
	/// <summary>
	/// </summary>
	public class Bak
	{
		...
		)
		{
			...
			{
				new sln.directory_.nonlink_.nonneglect_.giT_.work.Bak(cfg, innerModules,innerModules2reinclude) { module=this.module}.__Exe(folder);
			}
			else  //plain
			{
