...
namespace nilnul.dev.src.div_.folder_.nonlink
{
	/// <summary>
	/// the div is nonlink.
	/// if the src is nonlink, the whole path is nonlink.
	/// if the src is link, the path thence is nonlink
	/// </summary>
...
//		}
		...
		)
		{
			...
			{
				new folder_.nonlink_.nonneglect.Bak_srcsInAddresses(cfg).exe(_div_inSrc);
			}
			else
			{
