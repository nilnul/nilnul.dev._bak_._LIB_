...
namespace nilnul.dev.srcs.bak_._retVoid.sln_.nonlink.div_.nonlink_.git_.work_.top_.undone_.moduleUndone_._primed_
{
	/// <summary>
	/// </summary>
	/// 
	[Obsolete(
		//nameof(nilnul.dev.srcs.bak_._retVoid.sln_.nonlink.div_.nonlink_.git_.top_.undone_.moduleUndone_._primed_._SyncThisX)
		)]
