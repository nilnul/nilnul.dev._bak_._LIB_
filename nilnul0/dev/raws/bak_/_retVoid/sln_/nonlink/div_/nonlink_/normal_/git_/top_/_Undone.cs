...
namespace nilnul.dev.srcs.bak_._retVoid.sln.div_.git_.top_
{
	/// <summary>
	/// </summary>
	static public class _UndoneX
	{
		...
		)
		{
			...
			if (nilnul.dev.srcs.bak_._retVoid.SettingX.IsModuleBaked(folder))
			{
				...
				nilnul.dev.srcs.bak_._retVoid.sln.div_.normal_.git_.top_.undone_._ModuleDoneX._Exe(folder, cancel);
			}
			else
			{
