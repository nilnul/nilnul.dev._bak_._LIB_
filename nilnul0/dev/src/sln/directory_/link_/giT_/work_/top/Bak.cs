...
namespace nilnul.dev.src.sln.directory_.link_.giT_.work_.top
{
	/// <summary>
	/// 
	/// </summary>
	public class Bak4unjoint
	{
		...
		)
		{
			...
			if (old.Key is null)
			{
				...
				new directory_.unjoint_.giT_.work_.top.Bak_srcsInAddresses(cfg,innerModules,innerModules2reinclude) {module=this.module }._exe(shield);
