...
namespace nilnul.dev.src.sln.directory_.link_.giT_.work
{
	/// <summary>
	/// 
	/// </summary>
	public class Bak4unjoint
	{
		...
		)
		{
			...
			if (old.Key is null)
			{
				...
				new directory_.unjoint_.giT_.work.Bak4unjoint(cfg, innerModules,innerModules2reinclude,module) .__exe(shield);
