...
namespace nilnul.dev.src.sln.directory_.link_.giT_.plain
{
	/// <summary>
	/// 
	/// </summary>
	public class Bak4unjoint
	{
		...
		)
		{
			...
			if (old.Key is null)
			{
				...
				new directory_.unjoint_.giT_.plain.Bak4unjoint(cfg,innerModules,innerModules2reinclude) {module=this.module }.__exe(shield);
