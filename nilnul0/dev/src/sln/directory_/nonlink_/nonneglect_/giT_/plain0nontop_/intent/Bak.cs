...
namespace nilnul.dev.sln_.nonlink.directory_.nonlink_.nonneglect_.git_.plain0nontop_.intent
{
	/// <summary>
	/// 
	/// </summary>
	 public class Bak
	{
		...
		public void Exe( 
			...
			try
			{
				new sln_.nonlink.div_.nonlink_.nonneglect_.intent_.git_.plain0Nontop.Bak(cfg ).Exe(folderAddress);
