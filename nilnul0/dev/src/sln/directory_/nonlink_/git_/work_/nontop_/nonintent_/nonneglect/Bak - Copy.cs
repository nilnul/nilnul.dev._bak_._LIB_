...
namespace nilnul.dev.sln_.nonlink.directory_.nonlink_.giT_.work_.nontop_.nonintent_.nonneglect
{
	/// <summary>
	/// 
	/// </summary>
	 public class Bak_srcsInAddresses
	{
		...
		public void Exe( 
			...
			new nilnul.dev.sln_.nonlink.directory_.nonlink_.nonneglect_.giT_.work_.nontop_.nonintent.Bak_srcsInAddresses(cfg, innerModules,innerModules2reinclude) { module=this.module}._Exe(folderAddress);
		}
	}
}