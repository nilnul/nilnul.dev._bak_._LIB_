...
namespace nilnul.dev.src.sln.directory_.giT_.plain
{
	public class Bak
	{
		...
		)
		{
			...
			{
				new directory_.unjoint_.giT_.plain.Bak4unjoint(cfg,innerModules,innerModules2reinclude) { module=this.module}.__exe(work);
			}
