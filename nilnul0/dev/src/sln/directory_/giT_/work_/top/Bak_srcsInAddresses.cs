...
namespace nilnul.dev.src.sln.directory_.giT_.work_.top
{
	public class Bak_srcsInAddresses
	{
		...
		public void __exe(string work)
		{
			...
			{
				new directory_.link_.giT_.work_.top.Bak4unjoint(_cfg,innerModules,innerModules2reinclude) {module=this.module }.exe_ofAddress(work);

			}

			else
			{
				new directory_.unjoint_.giT_.work_.top.Bak_srcsInAddresses(cfg,innerModules,innerModules2reinclude) {module=this.module }.__exe(work);
			}
		}
