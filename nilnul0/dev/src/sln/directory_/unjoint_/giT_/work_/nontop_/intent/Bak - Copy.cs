...
namespace nilnul.dev.src.sln.directory_.unjoint_.giT_.work_.nontop_.intent
{
	/// <summary>
	/// 
	/// </summary>
	 public class Bak_srcsInAddresses
	{
		...
		public void Exe( 
			...
			try
			{
				...
				{
					new unjoint_.nonneglect_.giT_.work_.nontop_.intent.Bak_srcsInAddresses(cfg ).Exe(folderAddress);
				}
