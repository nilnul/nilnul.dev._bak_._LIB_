...
namespace nilnul.dev.src.sln.directory_.unjoint_.giT_.plain
{
	public class Bak4unjoint
	{
		...
		public void __exe(string work)
		{
			...
			{
				new unjoint_.nonneglect_.giT_.plain.Bak_srcsInAddresses(cfg,innerModules,innerModules2reinclude) { module =this.module }._exe(work);
			}
