...
namespace nilnul.dev.src.sln.directory_.unjoint_.nonneglect_.giT_.work_.nontop_.nonintent
{
	public class Bak_srcsInAddresses
	{
			...
			)
		{
			...
			new directory_.unjoint_.nonneglect_.nonintent_.giT_.work_.nontop.Bak_srcsInAddresses(cfg,innerModules,innerModules2reinclude,module) ._Exe(_location__nonrootWork);
