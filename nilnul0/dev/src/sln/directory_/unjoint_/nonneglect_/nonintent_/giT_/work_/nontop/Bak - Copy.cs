...
namespace nilnul.dev.src.sln.directory_.unjoint_.nonneglect_.nonintent_.giT_.work_.nontop
{
	public class Bak_srcsInAddresses
	{
			...
			)
		{
			...
			new div_.unjoint_.nonneglect_.nonintent_.giT_.work_.nontop.Bak_srcsInAddresses(cfg, innerModules,innerModules2reinclude,module)._exe(_location__nonrootWork);
