...
namespace nilnul.dev.src.sln.directory_.nonneglect_.unjoint_.giT_.nonplain
{
	/// <summary>
	/// excluding:
	///		a sub git managed(module or repo)
	/// </summary>
	public class Bak_srcsInAddresses
	{
		...
		)
		{
			...
			{
				new directory_.nonneglect_.unjoint_.giT_.work.Bak_srcsInAddresses(cfg, innerModules,innerModules2reinclude) { module=this.module}.__Exe(folder);
			}
