...
namespace nilnul.dev.sln_.nonlink.div_.nonlink_.nonneglect_.git_.plain0Nontop_.intent
{
	/// <summary>
	/// 
	/// </summary>
	public class Bak
	{
		...
		public void Exe( 
			...
			new nonneglect_.intent_.git_.plain0Nontop.Bak(cfg).Exe(folderAddress);
