...
namespace nilnul.dev.sln_.nonlink.div_.nonlink_.nonneglect_.git_.plain0Nontop_.nonIntent
{
	/// <summary>
	/// nonIntent so it's not a sln.
	/// </summary>
	public  class Bak
	{
		...
		internal void _Exe(string _location__nonrootWork
			)
		{
			new nonneglect_.nonintent_.git_.plain0Nontop.Bak(cfg, innerModules)._void(_location__nonrootWork);
