...
namespace nilnul.dev.sln.div_.nonlink_.nonneglect_.giT_.work_.top_._incomplete_.container_.undone_.primed._bak_
{
	/// <summary>
	...
	public static class _UploadX
	{
		...
		)
		{
			...
			try
			{
				bakBranch = sln_.nonlink.div_.nonlink_.nonneglect_.git_.work_.top_._incomplete_.container_.undone_.primed._bak_._upload_.branch_._bak.put._BranchOfNewContentX._Branch(
			...
			try
			{
				if (newlyCreatedBak)
				{
					...
					var bakBranchSuccess = sln_.nonlink.div_.nonlink_.nonneglect_.git_.work_.top_._incomplete_.container_.undone_.primed._bak_._upload_.branch_._BakX._Succed(
						 _location
						//,
						// innerModules
						,
					...
					if (!sln_.nonlink.div_.nonlink_.nonneglect_.git_.work_.top_._incomplete_.container_.undone_.primed._bak_._upload_.branch_._AllX._NoErr(_location, cancel, git))
					{
						noError = false;
					}
				}
