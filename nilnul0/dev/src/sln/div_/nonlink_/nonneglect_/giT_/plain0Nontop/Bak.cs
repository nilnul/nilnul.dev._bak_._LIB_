...
namespace nilnul.dev.sln_.nonlink.div_.nonlink_.nonneglect_.git_.plain0Nontop
{
	public class Bak
	{
		...
		{
			if (nilnul.fs.folder.be_.deV_.src_.bak_._AftX.Be_ofAddress(folder))
			{
				new plain0Nontop_.nondelay.Bak(_cfg)._Exe(folder);
