...
namespace nilnul.dev.src.sln.div_.unjoint_.nonneglect_.intent_.giT_.work
{
	/// <summary>
	/// 
	/// </summary>
	public class Bak_srcsInAddresses
	{
		...
		)
		{
			try
			{
				...
				{
					new intent_.giT_.plain0nontop.Bak_srcsInAddresses(cfg,innerModules,innerModules2reinclude,module).Exe(folderAddress);
				}
			}
