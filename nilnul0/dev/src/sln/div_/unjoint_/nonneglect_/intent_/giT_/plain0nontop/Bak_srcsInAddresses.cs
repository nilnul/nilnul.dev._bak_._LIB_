...
namespace nilnul.dev.src.sln.div_.unjoint_.nonneglect_.intent_.giT_.plain0nontop
{
	/// <summary>
	/// 
	/// </summary>
	public class Bak_srcsInAddresses
	{
		...
		)
		{
			...
			{
				new plain0nontop_.nontrivia.Bak_srcsInAddresses(cfg, innerModules, innerModules2reinclude,module)/* { module=this.module}*/.Exe(folderAddress);
