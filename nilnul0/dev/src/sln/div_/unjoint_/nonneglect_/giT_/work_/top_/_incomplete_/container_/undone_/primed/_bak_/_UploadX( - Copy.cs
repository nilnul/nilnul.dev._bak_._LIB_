...
namespace nilnul.dev.src.sln.div_.unjoint_.nonneglect_.giT_.work_.top_._incomplete_.container_.undone_.primed._bak_
{
	...
	public static class _UploadX
	{
		...
		)
		{
			...
			try
			{
				bakBranch = _upload_.branch_._shelf.put._BranchOfNewContentX._Branch(
			...
			{
				if (
					bak.nilnul0.dev.src.sln.div_.unjoint_.nonneglect_.giT_.work_.top_._incomplete_.container_.undone_.primed._bak_._upload.Settings1.Default.push4nonchange
