...
namespace nilnul.dev.src.sln.div_.unjoint_.nonneglect_.giT_.work_.top_._incomplete_.container
{
	/// <summary>
	/// </summary>
	public  class Bak_srcsInAddresses
	{
		...
		)
		{
			...
			{
				new _incomplete_.container_.undone.Bak_srcsInAddresses(cfg)._exe(folder,innerModules,innerModules2reinclude);
