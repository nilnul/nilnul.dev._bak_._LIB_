...
namespace nilnul.dev.src.sln.div_.unjoint_.nonneglect_.nonintent_.giT_.work_.top
{
	public class Bak
	{
		...
		{
			new nonneglect_.giT_.work_.top.Bak_srcsInAddresses(cfg,innerModules,innerModules2reinclude,module) { }._void(_location__nonrootWork);
