...
namespace nilnul.dev.src.sln.div_.unjoint_.nonneglect_.nonintent_.giT_.plain
{
	/// <summary>
	/// implemented by inheriting.
	/// </summary>
	public class Bak:nonneglect_.giT_._plain.Depth1st
	{
		

		public Bak(nilnul.fs.addresses_.disjoint.deV_._bak.Io cfg, ConcurrentBag<DivI> innerModules, ConcurrentBag<DivI> innerModules2reinclude, nilnul.fs.address_.ShieldI module):base(
