...
namespace nilnul.dev.src.sln.div_.nonneglect_.intent_.unjoint_.giT_.plain0nontop
{
	/// <summary>
	/// 
	/// </summary>
	public class Bak_srcsInAddresses
	{
		...
		{
			///cannonlize the sorting of namespace
				new div_.unjoint_.nonneglect_.intent_.giT_. plain0nontop.Bak_srcsInAddresses(cfg,innerModules,innerModules2reinclude,module).Exe(folderAddress);
