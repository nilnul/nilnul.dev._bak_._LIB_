...
//		}
		...
		)
		{
			...
			fs.address_.ShieldI parent = _cfg.srcs.shields.supOf(shield);
			...
			switch (distance)
			{
				case 0: //src
					...
					break;
				case 1: //sln
					new nilnul.dev.sln_.nonlink_.nonneglect.Bak(cfg).__Exe(_div_inSrc.ToString());
					break;

				default:    //inside sln
					new nilnul.dev.sln_.nonlink.directory_.nonlink_.nonneglect.Bak(cfg,new ConcurrentBag<fs._address.DivI>()).void0(
						 shield
						);
					break;
			}
